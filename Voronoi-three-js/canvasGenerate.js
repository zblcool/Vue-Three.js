...
// import * as  Delaunay  from "./dependacy/d3-delaunay.js";
function init() {
  ...
  // var triangles = voronoi.delaunay.inedges;
  // var halfedges = voronoi.delaunay.halfedges
  ...
  //     vertices.push(points[ti][0], points[ti][1], 0);
  //     vertices.push(points[tj][0], points[tj][1], 0);
  ...
  //       for (let i = 0; i < voronoi.circumcenters.length; i++) {
  //   // const pointElement = points[i];
  //   var t0 = voronoi.circumcenters[i*2];
  //   var t1 = voronoi.circumcenters[i*2+1]
  //   vertices.push(t0,t1, 0);
  //   normals.push(0, 0, 1);
  //   const r = t0 / 200 + 0.5;
  //   const g = t1 / 200 + 0.5;
  ...
  {
    // var totalNumber;
    // totalNumber = voronoi.circumcenters.length;
    ...
    // // vertices.push(t0,t1, 0);
    // // normals.push(0, 0, 1);
    //   geometryArray[i*3]=voronoi.circumcenters[i*2];
    //   geometryArray[1+i*3]=voronoi.circumcenters[i*2+1];
    ...
    // pointgeometry.setAttribute("position", new THREE.BufferAttribute( geometryArray,3));
    ...
    // });
    // let meshNew = new THREE.Points(pointgeometry, materialNew);
